...
Tdp(T,RH) = c*log(Pa(T,RH)/a)/(bb-log(Pa(T,RH)/a))
...
#set output "station_weather.png"
   plot   "station_weather.dat" using 3:($4*9.0/5.0+32.0) title 'temp1 F' with lines,\
      "station_weather.dat" using 3:($8*9.0/5.0+32.0) title 'temp2 F' with lines, \
      "station_weather.dat" using 3:($12*9.0/5.0+32.0) title 'temp3 F' with lines ls 6, \
